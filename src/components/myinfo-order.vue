...
<div class="account-content">
                ...
                <div class="box-inner order-cart order-list-cart clear" 
                    ...
                    <div class="gray-sub-title cart-title">
                        ...
                        <span class="order-detail">
                            <router-link  :to="{name: 'alipay',query: {orderid: item.id}}">查看详情&gt;</router-link>
                        </span> 
                    ...
                    <div class="cart">
                        <div class="cart-items clear" v-for="good, index in item.goodsdata">
                            <div class="prod-info clear">
                                <div class="items-thumb">
                                    <a href="javascript:;" target="_blank">
                        <img :src="`${good.ali_image}?x-oss-process=image/resize,w_80/quality,Q_100/format,webp`">
                                    </a>
                                </div>
                                <div class="items-params clear">
                                    <div class="name vh-center">
                                        <a href="javascript:;" target="_blank" 
                                            ...
                                            >{{good.title}}（{{good.spec_json.show_name}}）
                                        </a>
                                    </div>
    ...
    <div class="prod-operation">
        <div class="total">¥ {{item.totalprice}}.00</div>
        
        <div class="status"  v-if="!item.haspay">
            <router-link class="blue-small-btn js-payment-order"
            :to="{name: 'alipay', query: {orderid: item.id}}">现在付款</router-link>
        </div>
        <div v-else class="status" ><a class="js-payment-order has-pay">已完成</a></div>
    </div>
</div>
</div>
</div>
