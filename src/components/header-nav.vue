...
<div class="container">
  ...
  <ul class="nav-aside">
    <li class="nav-user"  >
      <a href="javascript:;" @mouseover="hidecarli">个人中心</a>
      <!--active-->
      <div class="nav-user-wrapper">
        <div class="nav-user-list">
          ...
          <ul>
            <router-link style="color: red" tag="li" class="order" :to="{name: 'myorder'}"><a href="javascript:;">我的订单</a></router-link>
            ...
            <router-link style="color: red" class="address" tag="li" :to="{name: 'myaddress'}"><a href="javascript:;">收货地址</a></router-link>
...
<div class="nav-sub-wrapper">
  <div class="container">
    <ul class="nav-list">
      <li>
        <router-link style="color: red" :to="{name:'index'}">首页</router-link>
      </li>
...
.nav-logo a {
  ...
  width: 50px;
  height: 50px;
  background: url(../assets/img/global-logo.png) no-repeat;
...
.nav-user-wrapper .nav-user-list ul li{
  display: block;
  margin: 0;
}
...
.nav-user-avatar span {
  ...
  width: 100%;
  height: 100%;
  background: url(../assets/img/user-avatar.png) no-repeat;
