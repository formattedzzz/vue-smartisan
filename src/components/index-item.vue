...
<div id="main">
    <div class="sku-box store-content">
        ...
        <div class="gray-box">
            <div class="item-box">
                <one-item  v-for="item, index in newGoodsData" :key="index" :item="item" ></one-item>
            </div>
        </div>
    </div>
    <alert/>
...
<script>
import newGoodsData from '@/lib/newGoodsData'
import oneItem from '@/components/one-item'
